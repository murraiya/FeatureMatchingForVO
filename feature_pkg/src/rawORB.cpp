...
cv::Ptr<cv::Feature2D> orb = cv::ORB::create(50);
...
int main(int argc, char** argv) {
    ...
    videoWriter.open("/media/autonav/SJ_SSD/Matching_ORB_raw_itisnotforpaper.avi", cv::VideoWriter::fourcc('M', 'P', 'E', 'G'), 50, cv::Size(3840,1200), 1); //u can modify framerate
